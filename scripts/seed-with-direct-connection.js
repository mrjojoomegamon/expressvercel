// Usar la conexión directa a Neon
const { neon } = await import("@neondatabase/serverless")

// Tu string de conexión de Neon
const DATABASE_URL =
  "postgres://neondb_owner:npg_VB5hGuE8kRCw@ep-sparkling-breeze-a4e90vnw-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require"

console.log("🔍 Connecting to Neon database...")
console.log("🔗 Host:", "ep-sparkling-breeze-a4e90vnw-pooler.us-east-1.aws.neon.tech")
...
async function seedTechEmporium() {
  try {
    ...
    console.log("🗄️  Database version:", connectionTest[0].db_version.split(" ")[0])
    ...
    console.log("🌐 Database Host: ep-sparkling-breeze-a4e90vnw-pooler.us-east-1.aws.neon.tech")
